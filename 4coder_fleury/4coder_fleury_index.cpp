...
function F4_Index_Note *
F4_Index_PushParent(F4_Index_ParseCtx *ctx, F4_Index_Note *new_active_parent)
{
  F4_Index_Note *n = ctx->active_parent;
  ctx->active_parent = new_active_parent;
  return n;
}

function void
F4_Index_PopParent(F4_Index_ParseCtx *ctx, F4_Index_Note *old_active_parent)
{
  ctx->active_parent = old_active_parent;
}
