...
modal_cursor_normal = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("modal_cursor_normal"));
modal_cursor_insert = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("modal_cursor_insert"));
modal_cursor_delete = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("modal_cursor_delete"));
modal_cursor_yank = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("modal_cursor_yank"));
modal_cursor_change = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("modal_cursor_change"));
modal_cursor_goto = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("modal_cursor_goto"));
modal_cursor_search = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("modal_cursor_search"));
modal_cursor_comment = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("modal_cursor_comment"));
