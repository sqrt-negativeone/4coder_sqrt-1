...
CUSTOM_UI_COMMAND_SIG(jump_to_definition_at_cursor_next_panel)
CUSTOM_DOC("Jump in the next panel to the first definition in the code index matching an identifier at the cursor")
{
    View_ID view = get_active_view(app, Access_Visible);
    view = get_next_view_looped_primary_panels(app, view, Access_Visible);
